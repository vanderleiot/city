		    	...
		    	if(enabled_advance_search=="yes"){
		    		...
		    		var tab_html='';
		    		 tab_html+='<ons-tabbar position="top" class="menu_tabbar" var="menu_tabbar" >';
		    		      ...
		    		      if(theme_name!=2){
						     tab_html+='<ons-tab page="page_search_byname.html" label="'+ getTrans('Name','name') +'" icon="ion-home"></ons-tab>';
		    		      }
		    		      if(theme_street_name!=2){
						     tab_html+='<ons-tab page="page_search_bystreet.html" label="'+ getTrans('Street','street') +'" icon="ion-map"></ons-tab>';
		    		      }
		    		      if(theme_cuisine!=2){
						     tab_html+='<ons-tab page="page_search_bycuisine.html" label="'+ getTrans('Cuisine','cuisine') +'" icon="ion-funnel"></ons-tab>';
		    		      }
		    		      if(theme_foodname!=2){
						     tab_html+='<ons-tab page="page_search_byfood.html" label="'+ getTrans('Food','food') +'" icon="ion-bag"></ons-tab>';
		    		      }
					 tab_html+='</ons-tabbar>';
...
{	 
	 ...
	 var sound_url= "file:///android_asset/www/notifica.mp3";
	 dump(sound_url);
	 if(!empty(sound_url)){
        playAudio(sound_url);
	 }
...
function googleLogin()
{
	if(isDebug()){
		...
		var params = "email=testgooglecom";
		params+="&userid=123";
...
playSound = function(){		 
	 try {	 		 	 
		 url = 'file:///android_asset/www/notifica.mp3';			 
