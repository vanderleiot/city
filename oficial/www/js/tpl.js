...
{
	var htm='';	
	htm+='<input type="text"  name="'+name+'"  id="cpf" class="cpf numeric_only text-input text-input--underbar" placeholder="'+placeholder+'" value="" has_validation data-validation="required" data-validation-error-msg="this field is mandatory!" >';
	htm+='</div>';
	return htm;
}
